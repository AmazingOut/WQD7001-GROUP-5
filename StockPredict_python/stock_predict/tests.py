...
class HistoryDataModelTests(TestCase):
    ...
    def test_set_data(self):
        ...
        """
        hd = HistoryData()
        list_data = [['2022-11-01', 1.2], ['2022-11-11', 10]]
        hd.set_data(list_data)
        self.assertEquals(hd.start_date, "2022-11-01")
        self.assertEquals(hd.data.replace(' ', ''), '[["2022-11-01",1.2],["2022-11-11]]')
...
class PredictDataModelTests(TestCase):
    ...
    def test_set_data(self):
        ...
        self.assertEquals(pd.start_date, "2022-11-01")
        self.assertEquals(pd.data.replace(' ', ''), '[["2022-11-01",1.2],["2022-11-11",10]]')
